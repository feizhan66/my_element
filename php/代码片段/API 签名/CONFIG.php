...
class CONFIG
{
    ...
    const ERROR_CODE_SIGNATURE_USER_LOGIN_PAST_DUE       = 5005;             // 用户没登录/登录已过期
    const ERROR_VALUE_SIGNATURE_USER_LOGIN_PAST_DUE      = "用户没登录/登录已过期";     // 用户没登录/登录已过期
    ...
    const ERROR_CODE_SIGNATURE_TAKE_DANGER_PARAM = 5009;//携带危险参数(Token)
    const ERROR_VALUE_SIGNATURE_TAKE_DANGER_PARAM = "Api携带了危险的签名参数";//携带危险参数(Token)
